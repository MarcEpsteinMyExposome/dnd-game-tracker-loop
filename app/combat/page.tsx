 ...
 * @see components/combat/AddToCombatModal.tsx - Modal for adding combatants
 */
 ...
 * from the roster. Manages modal state for adding combatants.
 *
 * Route: /combat
 *
 * @example
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <CombatTracker onAddCombatants={() => setShowAddModal(true)} />
